...
class MyViewFwUpdate extends MyViewHeader {
  ...
  function drawValues(_oDC as Gfx.Dc) as Void {
    ...
    _oDC.drawText(midX, midY - fontHeight * 2, Gfx.FONT_SMALL, "Update your glasses", justify); // (50%, 20%)
    _oDC.drawText(midX, midY - fontHeight, Gfx.FONT_SMALL, "using ActiveLook", justify); // (50%, 40%)
    _oDC.drawText(midX, midY, Gfx.FONT_SMALL, "mobile application", justify); // (50%, 60%)
  }
...
class MyViewFwUpdateDelegate extends Ui.BehaviorDelegate {
