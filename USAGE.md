...
livetracking updates in the My Vario app settings. For more details check the relevant
section below (there are some differences between SportsTrackLive, LiveTrack24 and FlySafe)
